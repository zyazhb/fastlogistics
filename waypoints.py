...
waylist = [[116.379028, 39.885042],[116.606476, 39.842024],[116.57941, 39.91557]]
...
def waypoints():
    ...
    return render_template('waypoints.html', province=province, number=number,waylist=waylist)
